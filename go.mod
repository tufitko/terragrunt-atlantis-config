...
require (
	github.com/transcend-io/terragrunt-atlantis-config latest
)

replace github.com/transcend-io/terragrunt-atlantis-config => github.com/tufitko/terragrunt-atlantis-config v1.23.45
