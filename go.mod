...
require (
	github.com/transcend-io/terragrunt-atlantis-config v1.20.0
)

replace github.com/transcend-io/terragrunt-atlantis-config => github.com/tufitko/terragrunt-atlantis-config v1.20.0
